...
v0.4.0 → v0.6.3 一次性补齐 tag 与 npm 发布(此前只提交、未打 tag);v0.6.4 起每个增量单独 tag。已发布版本连续无缺口(0.4.0 → 0.6.6)。
...
| v0.6.3 | `ae73864` | ✅ 0.6.3 |
| v0.6.4 | `3f7d890` | ✅ 0.6.4(D11 会话工作区) |
| v0.6.5 | `67d20f8` | ✅ 0.6.5(显示噪声) |
| v0.6.6 | `0e35439` | ✅ 0.6.6(D12 单步超时) |
| v0.6.7 | `b9eaf28` | ✅ 0.6.7(`latest`;通用跑书模板 + D13 lint 误报) |
