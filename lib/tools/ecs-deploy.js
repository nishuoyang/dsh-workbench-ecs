...
// ============================================================================
import { runWorkbench, decodeLoose, decodeCliOutput, commandLine, guardDestructiveCommand, omitUndefined, withInstanceLock } from '../common.js'
...
export function ecsDeployDefinition(ctx) {
  ...
  return {
    ...
    async execute(args, exec) {
      ...
      // 整段发布占用实例锁: 上传/重启/健康检查之间不被同实例的其它调用插入
