...
// ============================================================================
import { runWorkbench, decodeLoose, commandLine, omitUndefined, withInstanceLock } from '../common.js'
...
export function ecsDownloadDefinition(ctx) {
  return {
    ...
    async execute(args, exec) {
      ...
      const r = await withInstanceLock(args.instance_id, () => runWorkbench(ctx, argv, exec.signal, { exec }))
