...
// ============================================================================
import { runWorkbench, decodeCliOutput, commandLine, guardDestructiveCommand, omitUndefined, withInstanceLock } from '../common.js'
...
export function ecsDiagnoseDefinition(ctx) {
  return {
    ...
    output: {
      ...
      presentationMeta: (args, value) => omitUndefined({ kind: value.kind, instance_id: value.instance_id, exit_code: value.exit_code }),
    },
